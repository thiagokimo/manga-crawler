...
puts "Collecting pages from chapter #{random_chapter_number+1} of #{random_manga[0]}"
...
puts "There are #{pages.length} in chapter #{random_chapter_number+1} of #{random_manga[0]}"
